...
public class WebServiceCallHelper {
	...
	public WebServiceCallHelper(WebServiceCallbackable webServiceCallbackable,
	...
	private class DownloadWebpageTask extends
		...
		protected void onPostExecute(JSONObject result) {
			...
			webServiceCallbackable.webServiceCallback(statusCode, result);
		}
	}
	...
	private JSONObject makeWebServiceCall(String actionPath) throws IOException {
		...
		try {
			...
			try {
				jObj = new JSONObject(
						ConnectionHelper.getResponseString(response));
